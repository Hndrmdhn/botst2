...
//
const BotName = 'HND BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/hndrmdhn_'; // Nama Instagramlu cok
const whatsapplu = '0896-5290-3288'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'BELUM BIKIN'; // OFFICIAL GRUP LU 1
const grupch2 = 'BELUM BIKIN'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @hndrmdhn_`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @hndrmdhn_`)
})
